...
export const AddRoomButton = ({ remainingSlots, onClick }: AddRoomButtonProps) => {
  return (
    <button
      onClick={onClick}
      className="relative flex-shrink-0 w-full rounded-lg bg-white/80 border border-dashed border-gray-300 shadow-sm backdrop-blur-sm animate-fadeIn transition-all group hover:bg-white/90"
    >
